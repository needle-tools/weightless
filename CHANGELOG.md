...
- Added a stable `1.0.0` version and `--version`
- Added JSON output for exact machine-readable scans
- Added a refreshable Bubble Tea TUI with Summary and Models views
