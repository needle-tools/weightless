...
func main() {
	...
	flag.Usage = func() {
		...
		fmt.Fprintf(flag.CommandLine.Output(), "Find local model weights, VM stores, project caches, and LLM session files across AI apps, shared caches, and project folders.\n\n")
